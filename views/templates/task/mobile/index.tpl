<{extends file="layout.tpl"}>
	<{block name="head" append}>
		<title>试题库-首页</title>
		<link rel="stylesheet" type="text/css" href="../../interview/css/layout.css">
		<link rel="stylesheet" type="text/css" href="../../interview/css/index.css">
		<link href="//maxcdn.bootstrapcdn.com/font-awesome/4.2.0/css/font-awesome.min.css" rel="stylesheet">
		<script type="text/javascript" src="../../interview/js/jquery.min.js"></script> 
	<{/block}>
